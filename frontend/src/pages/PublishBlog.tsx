    ...
    return (
        <div className="w-full">
            ...
            <div className="max-w-screen-lg m-auto">
                ...
                <div className="mb-6">
                    <label htmlFor="default-input" className="block mb-2 text-md font-medium text-gray-900">Blog Title</label>
                    <input onChange={(e) => {
                        setTitle(e.target.value)
                    }} type="text" id="default-input" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Title of the Blog Post" />
                </div>
        ...
        <div>
            <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50">
                ...
                <div className="px-4 py-2 bg-white rounded-b-lg ">
                    ...
                    <textarea
                        onChange={onChange}
                        id="editor" rows={12} className="block w-full text-sm text-gray-800 bg-white border-0 outline-none" placeholder="Write an article..." required
                    />
                </div>
            </div>
        </div>
